...
void test_wifi_manager_notify_store_changed_copies_store(void)
{
    ...
    strncpy(store.entries[0].passphrase, "pass-1", sizeof(store.entries[0].passphrase) - 1);
    strncpy(store.entries[1].ssid, "ssid-2", sizeof(store.entries[1].ssid) - 1);
    strncpy(store.entries[1].passphrase, "pass-2", sizeof(store.entries[1].passphrase) - 1);
...
{
    s_ap_store.count = 2;
    strncpy(s_ap_store.entries[0].ssid, "ap-1", sizeof(s_ap_store.entries[0].ssid) - 1);
    strncpy(s_ap_store.entries[1].ssid, "ap-2", sizeof(s_ap_store.entries[1].ssid) - 1);
