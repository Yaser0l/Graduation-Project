...
static char s_last_vin[20] = {0};
static char s_last_payload[1024] = {0};
static esp_err_t s_publish_ret = 0;
...
int mqtt_stub_get_set_vin_calls(void) { return s_set_vin_calls; }
int mqtt_stub_get_publish_calls(void) { return s_publish_calls; }
const char* mqtt_stub_get_last_vin(void) { return s_last_vin; }
const char* mqtt_stub_get_last_payload(void) { return s_last_payload; }
...
void mqtt_stub_set_publish_result(esp_err_t ret) { s_publish_ret = ret; }
